...
{
	m_OnProxyRelay1.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay2( inputdata_t &inputdata )
{
	m_OnProxyRelay2.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay3( inputdata_t &inputdata )
{
	m_OnProxyRelay3.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay4( inputdata_t &inputdata )
{
	m_OnProxyRelay4.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay5( inputdata_t &inputdata )
{
	m_OnProxyRelay5.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay6( inputdata_t &inputdata )
{
	m_OnProxyRelay6.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay7( inputdata_t &inputdata )
{
	m_OnProxyRelay7.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay8( inputdata_t &inputdata )
{
	m_OnProxyRelay8.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay9( inputdata_t &inputdata )
{
	m_OnProxyRelay9.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay10( inputdata_t &inputdata )
{
	m_OnProxyRelay10.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay11( inputdata_t &inputdata )
{
	m_OnProxyRelay11.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay12( inputdata_t &inputdata )
{
	m_OnProxyRelay12.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay13( inputdata_t &inputdata )
{
	m_OnProxyRelay13.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay14( inputdata_t &inputdata )
{
	m_OnProxyRelay14.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay15( inputdata_t &inputdata )
{
	m_OnProxyRelay15.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
}

void CFuncInstanceIoProxy::InputProxyRelay16( inputdata_t &inputdata )
{
	m_OnProxyRelay16.CBaseEntityOutput::FireOutput( inputdata.value, inputdata.pActivator, inputdata.pCaller );
