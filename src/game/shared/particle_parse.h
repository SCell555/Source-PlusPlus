...
void DispatchParticleEffect( const char *pszParticleName, const Vector& vecOrigin, const QAngle& vecAngles, CBaseEntity *pEntity = NULL );
void DispatchParticleEffect( const char *pszParticleName, const Vector& vecOrigin, const Vector& vecStart, const QAngle& vecAngles, CBaseEntity *pEntity = NULL, bool bUseColor = false, const Vector& color1 = vec3_origin, const Vector& color2 = vec3_origin );
void DispatchParticleEffect( int iEffectIndex, const Vector& vecOrigin, const Vector& vecStart, const QAngle& vecAngles, CBaseEntity *pEntity = NULL, bool bUseColor = false, const Vector& color1 = vec3_origin, const Vector& color2 = vec3_origin );

void DispatchParticleEffect( const char *pszParticleName, ParticleAttachment_t iAttachType, CBaseEntity *pEntity, const char *pszAttachmentName, const Vector& vecColor1, const Vector& vecColor2, bool bUseColors=true, bool bResetAllParticlesOnEntity = false );
void DispatchParticleEffect( const char *pszParticleName, const Vector& vecOrigin, const QAngle& vecAngles, const Vector& vecColor1, const Vector& vecColor2, bool bUseColors=true, CBaseEntity *pEntity = NULL, int iAttachType = PATTACH_CUSTOMORIGIN );
