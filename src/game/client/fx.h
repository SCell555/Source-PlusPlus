...
void FX_MetalScrape( const Vector &position, const Vector &normal );
...
void FX_MuzzleEffect( const Vector &origin, const QAngle &angles, float scale, ClientEntityHandle_t hEntity, const unsigned char *pFlashColor = NULL, bool bOneFrame = false );
